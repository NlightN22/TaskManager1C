...
class GetTaskMessages @Inject constructor(
    ...
    operator fun invoke(userSettings: UserSettings, taskId: String): Flow<Request<TaskMessagesDTO>> =
        messagesRepository.getTaskMessages(userSettings, taskId).catch { e ->
            exceptionHandler(e)
        }.flowOn(ioDispatcher)
}